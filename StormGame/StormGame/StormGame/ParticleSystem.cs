...
namespace StormGame
{
    ...
    public abstract class ParticleSystem : DrawableGameComponent
    {
        ...
        protected override void LoadContent()
        {
            ...
            // load the texture....
            texture = Globals.Content.Load<Texture2D>(textureFilename);
        ...
        public void Draw()
        {
            ...
            // initializeConstants
            Globals.SpriteBatch.Begin(SpriteSortMode.Deferred, blendState);
            ...
            foreach (Particle p in particles)
            {
                ...
                Globals.SpriteBatch.Draw(texture, p.Position, null, color,
